...
class DeyeSun6kSg03Lp1Registers(DeyeBaseRegisters):
  def __init__(self, prefix: str = ''):
    ...
    self._battery_max_charge_current_register = IntWritableDeyeRegister(210, 0, 80, 'battery_max_charge_current', 'Battery Max Charge Current', 'A', avg = DeyeRegisterAverageType.fake_accumulate)
    self._battery_max_discharge_current_register = IntWritableDeyeRegister(211, 50, 120, 'battery_max_discharge_current', 'Battery Max Discharge Current', 'A', avg = DeyeRegisterAverageType.fake_accumulate)
    ...
    self._time_of_use_power_register = TimeOfUseIntWritableDeyeRegister(256, 0, 6000, 'time_of_use_power', 'Time Of Use Power', 'W', avg = DeyeRegisterAverageType.fake_accumulate)
