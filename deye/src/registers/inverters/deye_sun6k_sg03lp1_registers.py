...
class DeyeSun6kSg03Lp1Registers(DeyeBaseRegisters):
  def __init__(self, prefix: str = ''):
    ...
    self._battery_low_batt_soc_register = IntWritableDeyeRegister(219, 5, 60, 'battery_low_batt_soc', 'Battery Low Batt SOC', '%', DeyeRegisterAverageType.only_master)
    ...
    self._battery_restart_soc_register = IntWritableDeyeRegister(218, 5, 60, 'battery_restart_soc', 'Battery Restart SOC', '%', DeyeRegisterAverageType.only_master)
    self._battery_shutdown_soc_register = IntWritableDeyeRegister(217, 5, 60, 'battery_shutdown_soc', 'Battery Shutdown SOC', '%', DeyeRegisterAverageType.only_master)
