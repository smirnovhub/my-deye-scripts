...
class DeyeModbusInteractorAsync(DeyeModbusInteractor):
  ...
  async def process_enqueued_registers(self) -> None:
    ...
    DeyeModbusInteractorAsync._TOTAL_REGISTERS_GOT_FROM_CACHE += len(cached_registers)
    DeyeModbusInteractorAsync._TOTAL_REGISTERS_GOT_FROM_INVERTER += len(uncached_registers)
